...
void logo(), menu(), turunan(), integral(), integral2(int m, int n), matriks(), bantuan(), tentang(), error();
int main(){
	logo();
	menu();
}
void logo(){
	...
	printf("\t    `mMMMMMMMMMMMMMMMMMmNMMMMMMMMm                       omd. :so` :dd:     -hh. `hd+     `/sdho-\n");
	printf("\t     /NMMMMMMMMMMMMMMMMMMMMMMMMMN/                       mMModMMm- /MMd    `mMM: /MMm    .dMmyhNMy`\n");
	printf("\t      `:///////////////////////:`                        mMMMMm+   `dMM/:o:+MMd  +MMm    dMd`  :MMs\n");
	printf("\t                                                         mMMMN/     +MMNMMNNMM:  /MMm   .MMo   `mMm`\n");
	printf("\t                                                         mMMMMN+    `mMMMMMMMm   +MMm   `NMs   `NMd`\n");
	printf("\t                                                         mMM+mMMy`   +MMMNMMM/   +MMm`os:oMN/ .yMN:\n");
	printf("\t                                                         yNm.`yNN:   .dNd+mNh    -NMy-mNo /dNNMNh-\n");
	printf("\t                                                               .           .      `.        `..`\n\n\n\n\n");
	printf("%s", NORMAL);
...
void turunan(){
	...
	printf("%s", NORMAL);
	printf("Catatan: untuk saat ini, aplikasi hanya dapat menghitung turunan persamaan dengan nilai pangkat x dari -10 hingga 10,\n");
	printf("dan jumlah turunan yang dilakukan hingga 5 kali. Silahkan melihat bantuan pada menu utama untuk petunjuk lebih lanjut\n");
...
void integral(){
	...
	printf("y = ax^n + bx^(n - 1) + cx^(n - 2) + ... + z\n\n");
	printf("%s", NORMAL);
	printf("Catatan: untuk saat ini, aplikasi hanya dapat menghitung integral persamaan dengan nilai pangkat x dari -10 hingga 10,\n");
	printf("dan dengan batas bawah dan batas atas integral dari -10 hingga 10. Silahkan melihat bantuan pada menu utama untuk\n");
	printf("petunjuk lebih lanjut mengenai aplikasi.\n\n");
	do{
		printf("Masukkan nilai pangkat tertinggi (>= 10)\t: ");
		z = scanf("%d", &n);
		fflush(stdin);
